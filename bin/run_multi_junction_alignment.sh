...
CGALCODE_PREDICTION_GTF=${JUNCTION_TEST}/${SPECIES}_cgalcode_tot.gtf
...
ENSEMBL_GTF=${JUNCTION_TEST}/${SPECIES}_ensembl_tot.gtf #dog data
#ENSEMBL_GTF=${JUNCTION_TEST}/dog_ensembl_tot.gtf #dog data
#ENSEMBL_GTF=${JUNCTION_TEST}/mouse_ensembl_tot.gtf #mouse data
#ENSEMBL_GTF=${JUNCTION_TEST}/human_ensembl_tot.gtf #human data
	...
	do
		...
		if [ $filename != "junction_validation_$1_${DATE}" ]
			then
				...
				-b ../specific_junction_cga.bed -wa -wb -split -bed \
