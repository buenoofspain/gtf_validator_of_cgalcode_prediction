...
SPECIES=$1 #hs, mm or clf
echo "The species choice is write: $SPECIES"

#################################################
# The localisation where BAM files where located.
#TISSUE=$3
#TISSUE=/run/media/niguilla/Dyliss_NG/mouse_data/Sollner/Alignements/bam_test #test mouse data
#TISSUE=/run/media/niguilla/Dyliss_NG/IGDR_data/bam #dog data
#TISSUE=/run/media/niguilla/Dyliss_NG/mouse_data/Sollner/Alignements/BAM #mouse data
#TISSUE=/run/media/niguilla/Dyliss_NG/human_data/Wang/bam #human data

#if [ $SPECIES = "hs" ] || [ $SPECIES = "HS" ] || [ $SPECIES = "human" ] || [ $SPECIES = "Human" ]
#then
#	echo "The species is $1 and we choose the human data"
#	TISSUE=/run/media/niguilla/Dyliss_NG/human_data/Wang/bam #human data
#elif [ $SPECIES = "mm" ] || [ $SPECIES = "MM" ] || [ $SPECIES = "mouse" ] || [ $SPECIES = "Mouse" ]
#then
#	echo "The species is $1 and we choose the mouse data"
#	TISSUE=/run/media/niguilla/Dyliss_NG/mouse_data/Sollner/Alignements/BAM #mouse data
#elif [ $SPECIES = "clf" ] || [ $SPECIES = "CLF" ] || [ $SPECIES = "dog" ] || [ $SPECIES = "Dog" ]
#then
#	echo "The species is $1 and we choose the dog data"
#	TISSUE=/run/media/niguilla/Dyliss_NG/IGDR_data/bam #dog data
#else
#	echo "Not the good option"
#fi
...
JUNCTION_TEST=$2 
#JUNCTION_TEST=/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/test_validation_junction_samuel_200911/logol2bed_D0.5-2_hs.bed

#JUNCTION_TEST=/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_new_annotations/output_dog_with_ensembl98_data_in_ref #dog data
#JUNCTION_TEST=/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_new_annotations/output_mouse_with_ensembl98_data_in_ref #mouse data
#JUNCTION_TEST=/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_new_annotations/output_human_with_ensembl98_data_in_ref #human data
...
DATE=`date +%Y-%m-%d`
OUTPUT_DIR="junction_validation_${SPECIES}_${DATE}_${JUNCTION_TEST}"
