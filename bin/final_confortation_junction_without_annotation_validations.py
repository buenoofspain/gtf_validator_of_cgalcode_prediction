...
#    list_species_tr_validated = list()
    ...
    with open(directoryPath+"/result_bedtools_intersect.out", 'r') as path_d_f:
...
if __name__ == "__main__":
    ...
    path_dir = path+"output_dog_with_ensembl96_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_dog_with_ensembl98_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_dog_with_igdr_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_dog_with_ucsc_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
...
#    mappedResults_pathFile = "/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_reads_alignment_on_specific_junctions/dog_junction_exons/junction_validation_dog_2020-01-20/analysed/nb_reads_mapped_tissue.csv"
    ...
    path_dir = path+"output_human_with_ensembl96_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_human_with_ensembl98_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_human_with_ucsc_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_human_with_xbseq_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    ...
    mappedResults_pathFile = "/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_reads_alignment_on_specific_junctions/human_junction_exons/junction_validation_human_2019-12-18/analysed/nb_reads_mapped_tissue.csv"
    reduceJunctionReadsAlignmentResults(mappedResults_pathFile, sp, list_species_tr_validated)
    splitFileResultWithMappedReadReduced(sp)
    ...
    path_dir = path+"output_mouse_with_ensembl96_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_mouse_with_ensembl98_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_mouse_with_ucsc_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    
    path_dir = path+"output_mouse_with_xbseq_data_in_ref"
    list_species_tr_validated = createListDetailsValidationByAnnotation(path_dir, sp,list_species_tr_validated)
    ...
    mappedResults_pathFile = "/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_reads_alignment_on_specific_junctions/mouse_junction_exons/junction_validation_mouse_2019-11-26/analysed/nb_reads_mapped_tissue.csv"
    reduceJunctionReadsAlignmentResults(mappedResults_pathFile, sp, list_species_tr_validated)
    splitFileResultWithMappedReadReduced(sp)
