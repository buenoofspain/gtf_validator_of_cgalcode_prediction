...
def create_graph(file, number_of_junctions):
    ...
    for junction in name_junction :
        liste_junction.append(junction[0:0])
...
#            plot = plt.bar(ind, datafile[data], bottom= bottom_data)
        ...
        #Légende:
        plt.legend(liste_plot, tissue, loc=9, bbox_to_anchor=(0.5, 1.00), fontsize=8, ncol=8, title="Tissus") #ncol=8
        ...
        plt.ylabel("Nombre de lectures alignées")
        plt.xlabel("Jonction d'exons spécifiques")
