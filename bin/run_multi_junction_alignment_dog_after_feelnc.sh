...
CGALCODE_SPECIFIC_JUNCTION=/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/examples/validation_part2/dog_junction_exons/specific_junction_cga_not_in_feelnc.bed
	...
	do
		...
		if [ $filename != "junction_validation_$1_${DATE}" ]
			then
				...
				-b $CGALCODE_SPECIFIC_JUNCTION -wa -wb -split -bed \
