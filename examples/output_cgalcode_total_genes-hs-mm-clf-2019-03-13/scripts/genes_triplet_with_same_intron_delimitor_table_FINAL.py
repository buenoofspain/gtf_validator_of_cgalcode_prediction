...
from split_output_CGAlcode import extract_CGAlcode_output
...
def trGeneSeparator():
    #benchmark = "/home/niguilla/Documents/test_donnees_stat_cliques_doublons_singleton_181011/genes_one2one_hs_mm_clf_with_at_least_2_CCDS/test-hs-mm-clf-2018-10-11/analysis_tr_graphs/transcripts_with_prediction"
    #benchmark = "/home/niguilla/Documents/Data/genes_one2one_hs_mm_clf_with_at_least_2_CCDS/test_set_genes-hs-mm-clf-2018-10-20/transcripts_with_prediction"
...
#    parser.add_argument("-o", "--outputcga", dest = "outputcga", metavar = "CGA-Alcode output", help = "CG-Alcode output within the three comparison: HS-MM, HS-CLF & MM-CLF", required = False)
#    parser.add_argument("-o1", "--output_1", dest = "output_1", metavar = "CG_ALCODE_OUTPUT_1", help = "Output of CG-alcode programm", required = False)
#    parser.add_argument("-o2", "--output_2", dest = "output_2", metavar = "CG_ALCODE_OUTPUT_2", help = "Output of CG-alcode programm", required = False)
#    parser.add_argument("-o3", "--output_3", dest = "output_3", metavar = "CG_ALCODE_OUTPUT_3", help = "Output of CG-alcode programm", required = False)
...
#    outputcga = args.outputcga
    outputcga = "output_run2.txt"
    
    
    extract_CGAlcode_output(outputcga)
    hs_mm_o = "EXPORT_HSMM.txt"
    hs_clf_o = "EXPORT_HSCLF.txt"
    mm_clf_o = "EXPORT_MMCLF.txt"
...
#    graphAnalysis = args.graphAnalysis
    graphAnalysis = "graph_analysis.csv"
#    cliques = args.cliques
    cliques = "tr_repartition/clique.txt"
#    doublons = args.doublons
    doublons = "tr_repartition/doublons.txt"
#    singletons = args.singletons
    singletons = "tr_repartition/singletons.txt"
    
#    delimitorDict = args.delimitor
    delimitorDict = "output_dictionaries.txt"
#    transcripts = args.transcripts
    transcripts = "corresponding_tr_otr.txt"
    
    # Step 1: to generate output_common_comparison.csv
    dict_1 = extractGOWithinOutputFile(hs_mm_o)
    dict_2 = extractGOWithinOutputFile(hs_clf_o)
    dict_3 = extractGOWithinOutputFile(mm_clf_o)
