...
@author: niguilla
"""
rep = "/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_new_annotations/mouse/analyses_validation_annotation_2021_avril_23/"
...
with open(rep+"result_via_ENS96_mm.txt", 'r') as ens96_f_i:
...
with open(rep+"result_via_ENS98_mm.txt", 'r') as ens98_f_i:
...
with open(rep+"result_via_ENS102_mm.txt", 'r') as ens102_f_i:
...
with open(rep+"result_via_XBSEQ_mm.txt", 'r') as xbseq_f_i:
...
with open(rep+"result_via_UCSC_mm.txt", 'r') as ucsc_f_i:
