...
@author: niguilla
"""
rep = "/home/niguilla/Documents/Software/gtf_validator_of_cgalcode_prediction/predicted_transcripts_validation_with_new_annotations/human/analyses_validation_annotation_2021_avril_23/"
...
with open(rep+"result_via_ENS96_hs.txt", 'r') as ens96_f_i:
...
with open(rep+"result_via_ENS98_hs.txt", 'r') as ens98_f_i:
...
with open(rep+"result_via_ENS102_hs.txt", 'r') as ens102_f_i:
...
with open(rep+"result_via_ENS103_hs.txt", 'r') as ens103_f_i:
...
with open(rep+"result_via_XBSEQ_hs.txt", 'r') as xbseq_f_i:
    lecture = xbseq_f_i.readlines()
    db_source = "XBSEQ"
    for tr in lecture:
...
with open(rep+"result_via_UCSC_hs.txt", 'r') as ucsc_f_i:
...
print("Number of transcript found in XBSEQ:", nb_tr_validated_by_xbseq)
